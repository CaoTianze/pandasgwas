...
def test_get_variants_by_study_id():
    ...
    assert df.single_nucleotide_polymorphisms.size == 6 * 4
...
def test_get_variants_by_association_id():
    ...
    assert df.single_nucleotide_polymorphisms.size == 6 * 1
...
def test_get_variants_by_efo_id():
    ...
    assert df.single_nucleotide_polymorphisms.size == 6 * 398
...
def test_get_variants_by_genomic_range():
    ...
    assert df.single_nucleotide_polymorphisms.size == 6 * 267
...
def test_get_variants():
    ...
    assert df.single_nucleotide_polymorphisms.size == 6 * 5
